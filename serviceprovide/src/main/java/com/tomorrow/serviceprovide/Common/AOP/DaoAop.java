package com.tomorrow.serviceprovide.Common.AOP;
...
public class DaoAop {
     ...
     */
    @Pointcut("execution(public * com.tomorrow.serviceprovide.Dao.Mapper..*.insert*(..))")
    public void insertBaseData(){}

    /**
     * 拦截跟新操作  维护基本信息 例如 创建人、创建时间
     */
    @Pointcut("execution(public * com.tomorrow.serviceprovide.Dao.Mapper..*.update*(..))")
